...
<html>
    ...
    <body>
        <div class="container" style="padding-top:20px; padding-bottom:100px; max-width: 800px;">
            ...
            <h2 style="font-family:arial bold;">Modificar Vehiculo</h2>
                <div class="form-group autocomplete">
                    <label for="registros_nombre">Propietario:</label>
                    <input type="text" class="form-control" id="registros_nombre" placeholder="Especifique al cliente..." name="registros_nombre">
                </div>
            <div class="form-inline form-group autocomplete">
                <label for="marca" style="padding-right:20px;">Marca:</label>
                <input type="text" class="form-control" id="marca" placeholder="Busqueda por marca..." name="marca" readonly>
                <label for="matricula" style="padding-right:20px; padding-left: 40px">Matricula:</label>
                <input type="text" class="form-control" id="matricula" name="matricula" style="width: 40%" readonly>                                
            </div>
            <div class="form-inline form-group">
                <label for="modelo" style="padding-right:20px">Modelo:</label>
                <input type="text" class="form-control" id="modelo" name="modelo" style="width: 41%" readonly>                
            ...
            <div class="form-group inline-group">
                <form action="eliminarAuto.php" method=post onsubmit="eliminar()" style="float: left; padding-right: 20px;">
                <input id="eliminarAuto" name="eliminarAuto" type=hidden>             
                <input type="submit" class="btn btn-dark" value="Eliminar Vehiculo" id="btnEliminar" disabled>
                </form>
                <form action="modificarAuto.php" method=post onsubmit="modificar()">
                <input id="modificarAuto" name="modificarAuto" type=hidden>             
                <input type="submit" class="btn btn-dark" value="Modificar vehiculo" id="btnModificar" disabled>
                </form> 
            </div>
        </div>
    </body>
